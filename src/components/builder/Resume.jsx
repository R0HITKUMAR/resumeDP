...
export default function Resume(props) {
  ...
  React.useEffect(() => {
    ...
    axios
      .get(`https://resumedp.herokuapp.com/education/retrieveAll/${email}`)
      .then((res) => {
        setEducation(res.data);
      });
    axios
      .get(`https://resumedp.herokuapp.com/project/retrieveAll/${email}`)
      .then((res) => {
        setProjects(res.data);
      });
    axios
      .get(`https://resumedp.herokuapp.com/certificate/retrieveAll/${email}`)
      .then((res) => {
        setCertificates(res.data);
      });
    axios
      .get(`https://resumedp.herokuapp.com/achievement/retrieveAll/${email}`)
      .then((res) => {
